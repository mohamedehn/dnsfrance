            ...
            <div className="mt-8 items-center justify-between sm:flex pt-0">
                ...
                <div className="mt-3 sm:mt-0 pb-3 sm:pb-0">
                    <ul className="flex items-center space-x-4">
                        ...
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <Link href="https://www.facebook.com/people/Data-Network-Solutions/100083318296242/">
                        ...
                        <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                            <Link href="https://www.linkedin.com/company/dnsfrance/">
                ...
                <ul className="items-center justify-center space-y-5 sm:flex sm:space-x-4 sm:space-y-0 ">
                {
                    ...
                    <li className="hover:text-gray-800 list-none"> 
                        <Link href="https://mohamedehn.github.io/portfolio/">Powered by Coding Corp</Link>
                    </li>
                </ul>
            </div>
            <style jsx="true">{`
